...
public class StudentTable extends JPanel {
	...
	private void configureColumnWidths() {
		...
		if (tableType == STANDARD_STUDENT_TABLE_TYPE) {
			...
			table.getColumnModel().getColumn(StudentTableModel.AGE_COLUMN).setMaxWidth(48);
			table.getColumnModel().getColumn(StudentTableModel.START_DATE_COLUMN).setMaxWidth(105);
			table.getColumnModel().getColumn(StudentTableModel.LAST_VISIT_DATE_COLUMN).setMaxWidth(105);
			...
			table.getColumnModel().getColumn(StudentTableModel.LAST_VISIT_DATE_COLUMN).setPreferredWidth(100);
	...
	private void createStudentTablePopups() {
		...
		showStudentInfoItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				table.clearSelection();
				studentListener.viewStudentTableByStudent(Integer.parseInt(clientID));
			}
		});
		...
		showStudentEmailItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				table.clearSelection();
				studentListener.viewEmailByStudent(Integer.parseInt(clientID));
			}
		});
